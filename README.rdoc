...
And do pagination:
    ...
    @posts = Post.text_search('redis', :page => 1)  # use class.per_page like will_paginate
    
And +text_search+ can handle +AND+ and +OR+ tokens:

    @posts = Post.text_search('technical AND ruby')
    @posts = Post.text_search('technical OR howto OR ruby')

Which makes it easy to attach an HTML form to it.
